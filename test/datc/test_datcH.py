...
class TestDATC_H(unittest.TestCase):
    ...
    def test_6_h_16(self):
        ...
        b.moves_adjudicate(self)
        self.assertFalse(f_western_mediterranean.retreat_options != None and b.spain in f_western_mediterranean.retreat_options, "Spain should not be a retreat option")
